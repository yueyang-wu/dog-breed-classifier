...
TRAIN_LABEL_CSV_PATH = './data/experiment_train_data.csv'  # training images and labels
...
def plot_result(accuracy_arr, loss_arr, label):
...
def main():
    ...
    for lr in LEARNING_RATE:
        ...
        plot = plot_result(accuracy_arr, loss_arr, label)
